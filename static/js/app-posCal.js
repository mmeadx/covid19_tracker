console.log("app-posCal.js running")
  ...
  d3.json("https://api.covidtracking.com/v1/us/daily.json").then((data) => {
    ...
    const svg = d3.select("#svgPos");
    const { width, height } = document
        .getElementById("svgPos")
    ...
    function draw() {
        ...
        return {
            upperBound,
            lowerBound,
            color: d3.interpolateYlOrBr(upperBound / maxValue),
            selected: true
        };
        });
        ...
        year
            ...
            .transition()
            .duration(700)
            .attr("fill", d => (legend.selected ? colorFn(d.value) : "#ffffe6"));
        }
